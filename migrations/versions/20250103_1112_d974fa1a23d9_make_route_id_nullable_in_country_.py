"""make_route_id_nullable_in_country_segments

Revision ID: d974fa1a23d9
Revises: a0e79ffbf702
Create Date: 2025-01-03 11:12:36.834246+00:00
...
revision: str = 'd974fa1a23d9'
down_revision: Union[str, None] = 'a0e79ffbf702'
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.VARCHAR(length=36), nullable=False),
    sa.Column('transport_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('business_entity_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('cargo_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('origin_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('destination_id', sa.VARCHAR(length=36), nullable=True),
    ...
    sa.Column('start_location_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('end_location_id', sa.VARCHAR(length=36), nullable=True),
