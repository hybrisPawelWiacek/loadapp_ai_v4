...
def upgrade() -> None:
    ...
    op.create_table(
        'empty_drivings',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('distance_km', sa.Float(), default=200.0),
        sa.Column('duration_hours', sa.Float(), default=4.0)
    )
    ...
    op.create_table(
        'routes',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('transport_id', sa.String(36),
                 sa.ForeignKey('transports.id'), nullable=False),
        sa.Column('business_entity_id', sa.String(36),
                 sa.ForeignKey('business_entities.id'), nullable=False),
        sa.Column('cargo_id', sa.String(36),
                 sa.ForeignKey('cargos.id'), nullable=False),
        sa.Column('origin_id', sa.String(36),
        ...
        sa.Column('empty_driving_id', sa.String(36),
                 sa.ForeignKey('empty_drivings.id'), nullable=False),
        sa.Column('total_distance_km', sa.Float(), nullable=False),
        sa.Column('total_duration_hours', sa.Float(), nullable=False),
        sa.Column('is_feasible', sa.Boolean(), default=True)
    )
    ...
    op.create_table(
        ...
        sa.Column('duration_hours', sa.Float(), default=1.0),
    ...
    op.create_table(
        ...
        sa.Column('route_id', sa.String(36),
                 sa.ForeignKey('routes.id'), nullable=False),
        sa.Column('cost_breakdown_id', sa.String(36),
                 sa.ForeignKey('cost_breakdowns.id'), nullable=False),
