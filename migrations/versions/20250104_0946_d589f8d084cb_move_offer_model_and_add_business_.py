...
def upgrade() -> None:
    ...
    op.drop_index('ix_route_status_history_route_id', table_name='route_status_history')
    op.drop_index('ix_route_status_history_timestamp', table_name='route_status_history')
...
def downgrade() -> None:
    ...
    op.create_index('ix_route_status_history_timestamp', 'route_status_history', ['timestamp'], unique=False)
    op.create_index('ix_route_status_history_route_id', 'route_status_history', ['route_id'], unique=False)
    op.create_table('cargo_status_history',
    sa.Column('id', sa.VARCHAR(length=36), nullable=False),
    sa.Column('cargo_id', sa.VARCHAR(length=36), nullable=False),
    sa.Column('old_status', sa.VARCHAR(length=50), nullable=False),
    sa.Column('new_status', sa.VARCHAR(length=50), nullable=False),
    sa.Column('trigger', sa.VARCHAR(length=50), nullable=False),
    sa.Column('trigger_id', sa.VARCHAR(length=36), nullable=True),
    sa.Column('timestamp', sa.DATETIME(), nullable=False),
    ...
    sa.Column('validation_details', sqlite.JSON(), server_default=sa.text("'{}'"), nullable=False),
    sa.ForeignKeyConstraint(['business_entity_id'], ['business_entities.id'], ),
    sa.ForeignKeyConstraint(['cargo_id'], ['cargos.id'], ),
    ...
    sa.Column('id', sa.VARCHAR(length=36), nullable=False),
    sa.Column('offer_id', sa.VARCHAR(length=36), nullable=False),
    sa.Column('old_status', sa.VARCHAR(length=50), nullable=False),
    sa.Column('new_status', sa.VARCHAR(length=50), nullable=False),
    sa.Column('trigger', sa.VARCHAR(length=50), nullable=False),
    sa.Column('trigger_id', sa.VARCHAR(length=36), nullable=True),
